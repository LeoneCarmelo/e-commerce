            ...
            <div class="card-body">
                <form wire:submit="update">
                    <div class="mb-3">
                        ...
                        <small id="helpId" class="text_">Type the name of the product</small>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <small id="helpId" class="text_">Type your description</small>
                        @error('description')
                    ...
                    <div class="mb-3">
                        ...
                        <small id="helpId" class="text_">Type the weight of the product</small>
                        @error('weight')
                            <div class='invalid-feedback'>{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input wire:model="price" type="text" name="price" id="price" class="form-control bg_quaternary"
                            aria-describedby="helpId" value=""/>
                        <small id="helpId" class="text_">Type the price of the product</small>
                        @error('price')
                            <div class='invalid-feedback'>{{ $message }}</div>
                        @enderror
                    </div>
